    ...
    <div class="container mx-auto px-4 sm:px-6 pt-32 pb-20">
      <div class="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <img
              src="/images/screenshots/wallet-screen.png"
              alt="Labas App - Wallet Screen"
          ...
          >
            <img
              src="/images/screenshots/my-bookings-screen.png"
              alt="Labas App - My Bookings Screen"
              class="w-full h-auto drop-shadow-2xl"
              loading="eager"
            />
          </div>
